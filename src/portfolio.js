...
const greeting = {
  ...
  title2: "Ishan",
  logo_name: "Ishan.c",
  customGreeting: "hey i am ishan",
  nickname: "Ishan_dai",
  full_name: "Ishan chaulagian",
  // subTitle:
  //   "Full Stack Developer, Machine Learning Enthusiast. Always learning.",
  resumeLink:
    "https://drive.google.com/file/d/1kcvW8P65jWZFeKR6Jopf3nrQLA1qJCwn/view?usp=sharing",
  mail: "mailto:Ishanchaulagain30@gmail.com",
};
  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Backend development using NodeJSand Flask",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
...
const degrees = {
  degrees: [
    {
      title: "Baba boarding high school",
      subtitle: "Pre schooling to primary education",
      logo_path: "dal.png",
      alt_name: "DAL",
      duration: "2002 - 2018",
      descriptions: [
        "⚡ studied form grade 1 to 10 ",
        "⚡ Completed my SEE from here with good academic record.",
        "⚡ performed basic science experiments and computer studies.",
      ],
      website_link: "https://www.baba.edu.np/",
    },
    {
      title: "Uniglobe higher secondary school",
      subtitle: "+2 Science",
      logo_path: "sal.png",
      alt_name: "SETI",
      duration: "2019 - 2021",
      descriptions: [
        "⚡ studied Physics, Chemistry and Mathematics in +2 science stream.",
        "⚡ learned the basic concepts of computer science and programming.",
        "⚡also performed lab works related to physics and chemistry.",
      ],
...
const experience = {
  ...
  description:
  "The best experience you can have is learing by your self,a learner trying to learn his way in life",
